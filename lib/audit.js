...
async function fetchPlacesData(bizName, placeId) {
  ...
  const detailUrl = 'https://maps.googleapis.com/maps/api/place/details/json'
    ...
    + ',opening_hours,website,photos,types,editorial_summary,description,reviews,business_status'
    + '&key=' + apiKey;
...
function formatPlacesData(p) {
  ...
  const lines = [
    ...
    'Description: '      + (p.editorial_summary?.overview || p.description || 'No description set'),
  ];
  if (p.opening_hours) {
